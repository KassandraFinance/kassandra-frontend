    ...
    <S.Token>
      ...
      <S.KassandraCardWrapper>
        <S.KassandraCard className="firstCard">
          ...
          <span>Every investment product created with Kassandra must hold at least 5% of $KACY tokens as part of its portfolio. This ensures that the success of the products will result in the growth of the $KACY token value.</span>
        </S.KassandraCard>
