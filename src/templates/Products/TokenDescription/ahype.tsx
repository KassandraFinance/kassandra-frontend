...
const AhypeDescription = () => {
  ...
  return (
    <>
      <p>
        The Avalanche Social Index (aHYPE) tracks the performance of a portfolio
        composed of the most socially active cryptocurrencies in the last 30
        days. This portfolio is weighted according to the social score made
        available by Heimdall and the technology provided by the Kassandra
        Protocol. The portfolio is a SIP (Smart Index Pool) and is rebalanced by
        arbitrageurs just like a usual liquidity pool. The index is accompanied
        by its own token $aHYPE, allowing investors to buy the index by
      ...
      <p>
        ...
        develop a tool which can measure the popularity of a particular crypto,
        this tool is the creation of Heimdall and it is the bedrock of the
        index.
      </p>
      ...
      <p>
        ...
        write the new weights on the blockchain. These gas costs will be covered
        using funds from a wallet managed by the DAO and funded by the exit fees
        collected from users. Losses in arbitrage are alleviated by swap fees
        and the smart allocation of the assets.
      </p>
      <span>
      ...
      <ol>
        ...
        <li>
          Using API3 we make the social score data available in the blockchain.
        </li>
        <li>
      ...
      <p>
        For the reasons above, we have determined that weights are to be updated
        every 24 hours. To avoid large jumps that could lead to large
      ...
      <p>
        ...
        to the whitelist must be available on the Avalanche blockchain and meet
...
export default AhypeDescription
