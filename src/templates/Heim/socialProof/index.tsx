        ...
        <MediaMatch greaterThan='medium'>
          ...
          <S.ItemContainer>
            ...
            <S.ItemText>
              ...
              <S.ItemSubtitle>While Bitcoin is not the most technologically sophisticated cryptocurrency, nor the most efficient, it is the largest, most popular, and successful cryptocurrency.</S.ItemSubtitle>
              <S.ItemSubtitle>That is the <strong>network effect</strong>, the people that trust and build around the project.</S.ItemSubtitle>
            </S.ItemText>
          </S.ItemContainer>
        ...
        <S.Divider>
          ...
          <S.ProductWrapper>
            <S.ProductContainer>
              ...
              <S.ProductText>
                <S.ProductSubtitle>Empowered by machine learning and aother powerful algorithms, Heimdall feeds data to the Heim Social Index to balance their holdings according to the community size and engagement of each project.</S.ProductSubtitle>
              </S.ProductText>
                <S.Link>
          ...
          <S.ProductContainer>
              ...
              <S.ProductText>
                <S.ProductSubtitle>The Kassandra Protocol connects external data to live decentralized ETFs, allowing Heimdall to manage the fund allocations while empowering the DAO to curate, approve and manage the investable assets for the strategy.</S.ProductSubtitle>
              </S.ProductText>
              <S.Link>
