            ...
            <S.ItemContainer>
              ...
              <S.ItemText>
                ...
                <S.ItemSubtitle>
                  ...
                  cryptocurrency, nor the most efficient, it is the largest,
            ...
            <S.ItemContainer>
              <S.ItemText>
                ...
                <S.ItemSubtitle>
                  ...
                  search engine, in a form that to a community have a high
                  social score, this community must have key influencers
                  connected to it.
                </S.ItemSubtitle>
                <S.ItemSubtitle>
          ...
          <S.ProductContainer>
            ...
            <S.Link>
              <a
                ...
                onClick={() =>
                  clickMatomoEvent('click-to-heimdall', 'social-proof')
                }
              >
                Learn more &#8594;
              </a>
          ...
          <S.ProductContainer>
            ...
            <S.ProductText>
              <S.ProductSubtitle>
                ...
                allocations while empowering the DAO to curate, approve and
                manage the investable assets for the strategy.
              </S.ProductSubtitle>
            </S.ProductText>
            <S.Link>
              <a
                ...
                onClick={() =>
                  clickMatomoEvent('click-to-kassandra', 'social-proof')
                }
              >
                Learn more &#8594;
              </a>
