      ...
      <section className={styles['kassandra-success']}>
        ...
        <div className={styles.successgrid}>
          <div className={styles.successitem}>
            <Image src="/assets/group-success-5percent.svg" alt="5%" width={150} height={150} />
          ...
          <div className={styles.successitem}>
            <Image src="/assets/group-success-3percent.svg" alt="3%" width={150} height={150} />
            <h2>Redeem Fee</h2>
          ...
          <div className={styles.successitem}>
            <Image src="/assets/group-success-vote.svg" alt="" width={150} height={150} />
            <h2>Vote Lock</h2>
