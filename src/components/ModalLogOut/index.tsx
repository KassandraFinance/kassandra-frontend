  ...
  return (
    <>
      ...
      <S.ModalContainer modalOpen={modalOpen}>
        <S.Top>
          <p>Your wallet</p>
          <S.Close type="button" onClick={() => setModalOpen(false)} ><img src="assets/close.svg" alt="" /></S.Close>
        </S.Top>
        <S.Content>
          ...
          <S.ButtonContainer>
            ...
            >
              ...
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M6.39998 3.19995H2.59998C2.04769 3.19995 1.59998 3.64767 1.59998 4.19995V13.4C1.59998 13.9522 2.04769 14.4 2.59997 14.4H11.8C12.3523 14.4 12.8 13.9522 12.8 13.4V9.59995" stroke="#26DBDB" stroke-linecap="round"/>
                <path d="M6.04647 9.24647C5.85121 9.44173 5.85121 9.75832 6.04647 9.95358C6.24173 10.1488 6.55832 10.1488 6.75358 9.95358L6.04647 9.24647ZM14.1 2.40002C14.1 2.12388 13.8762 1.90002 13.6 1.90002L9.10002 1.90002C8.82388 1.90002 8.60002 2.12388 8.60002 2.40002C8.60002 2.67617 8.82388 2.90002 9.10002 2.90002L13.1 2.90002L13.1 6.90002C13.1 7.17617 13.3239 7.40002 13.6 7.40002C13.8762 7.40002 14.1 7.17617 14.1 6.90002L14.1 2.40002ZM6.75358 9.95358L13.9536 2.75358L13.2465 2.04647L6.04647 9.24647L6.75358 9.95358Z" fill="#26DBDB"/>
              </svg>
            </a>
          </S.ButtonContainer>
        </S.Content>
